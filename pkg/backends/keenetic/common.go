...
func (c *keeneticCommon) Version() (models.Version, error) {
...
func (c *keeneticCommon) ExecutePostParse(parse ...models.ParseRequest) ([]models.ParseResponse, error) {
	parseCopy := parse
	var parseResponses []models.ParseResponse
	var mErr error
	for len(parseCopy) > 0 {
...
func (c *keeneticCommon) ShowRunningConfig() (models.RunningConfig, error) {
	var runningConfig models.RunningConfig
...
func (c *keeneticCommon) SaveConfigParseRequest() models.ParseRequest {
	return models.ParseRequest{Parse: "system configuration save"}
}

// EnsureSaveConfigAtEnd ensures SaveConfigParseRequest is at the end of parseSlice if not already present
func (c *keeneticCommon) EnsureSaveConfigAtEnd(parseSlice []models.ParseRequest) []models.ParseRequest {
...
func (c *keeneticCommon) CheckRouterMode() (string, string, error) {
	...
	var systemMode models.SystemMode
